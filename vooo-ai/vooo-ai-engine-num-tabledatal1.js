...
const _ENGINE_JSON_FILE     = 'num-tabledata-level-1.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'num-tabledata-level-1';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
