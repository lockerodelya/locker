...
const _ENGINE_JSON_FILE     = 'interpretation-tabledata-level-1.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'interpretation-tabledata-level-1';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'voooEngineTabledatal1';               // ⭐ Line 3: Unique global variable name for this engine
