...
const _ENGINE_JSON_FILE     = 'upsc-profitloss-level-2.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'upsc-profitloss-level-2';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
