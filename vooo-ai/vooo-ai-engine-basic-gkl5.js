...
const _ENGINE_JSON_FILE     = 'basic-gk-level-5.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'basic-gk-level-5';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'voooEngineBasicGKL5';               // ⭐ Line 3: Unique global variable name for this engine
