...
const _ENGINE_JSON_FILE     = 'upsc-arguments-level-3.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'upsc-arguments-level-3';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'vaeupscargumentsl3';               // ⭐ Line 3: Unique global variable name for this engine
...
if(template.answer_label&&Array.isArray(template.answer_label)){
    ...
    const pool=["All four are strong","I, II and III are strong","I, II and IV are strong","II and IV are strong","I, III and IV are strong","II, III and IV are strong"];
