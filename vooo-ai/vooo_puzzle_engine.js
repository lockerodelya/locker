...
class VOOOPuzzleEngine {
    constructor() {
        ...
        this.usedQuestions = [];
        this.categories = {
            'toddler_math': 'math_toddler.json',
            'toddler_reasoning': 'reasoning_toddler.json',
            ...
            'sudoku_intermediate': 'sudoku_intermediate.json',
            'sudoku_advanced': 'sudoku_advanced.json',
            'grid_intermediate': 'grid_intermediate.json',
            'grid_advanced': 'grid_advanced.json',
