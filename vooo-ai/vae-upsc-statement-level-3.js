...
generateOptions(correctAnswer,template,variables){
    ...
    if(template.answer_label&&Array.isArray(template.answer_label)){
        ...
        const pool=['Valid','Not Valid','Both I and II','Only Conclusion I','Only Conclusion II','Neither I nor II','Only Assumption I','Only Assumption II','I and II only','I and III only','I and IV only','II and III only','II and IV only','III and IV only','I, II and III','I, II and IV','I, III and IV','II, III and IV','I, II, III and IV'];
        let opts=[...unique];
