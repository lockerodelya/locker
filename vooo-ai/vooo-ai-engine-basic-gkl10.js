...
const _ENGINE_JSON_FILE     = 'basic-gk-level-10.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'basic-gk-level-10';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'voooEngineBasicGKL10';               // ⭐ Line 3: Unique global variable name for this engine
