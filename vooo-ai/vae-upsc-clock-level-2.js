...
const _ENGINE_JSON_FILE     = 'upsc-clock-level-2.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'upsc-clock-level-2';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'vaeupscclockl2';               // ⭐ Line 3: Unique global variable name for this engine
