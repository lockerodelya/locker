...
const _ENGINE_JSON_FILE     = 'environmental-human-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-human-level-1';
const _ENGINE_INSTANCE_NAME = 'environmentalhumanl1';
