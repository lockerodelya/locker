...
const _ENGINE_JSON_FILE     = 'physics-electricity-magnetism-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'physics-electricity-magnetism-level-1';
const _ENGINE_INSTANCE_NAME = 'physicselectricitymagnetisml1';
