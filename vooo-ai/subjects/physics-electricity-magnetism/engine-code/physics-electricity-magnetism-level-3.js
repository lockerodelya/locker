...
const _ENGINE_JSON_FILE     = 'physics-electricity-magnetism-level-3.json';
const _ENGINE_CATEGORY_KEY  = 'physics-electricity-magnetism-level-3';
const _ENGINE_INSTANCE_NAME = 'physicselectricitymagnetisml3';
