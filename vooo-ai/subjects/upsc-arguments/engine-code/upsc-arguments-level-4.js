...
const _ENGINE_JSON_FILE     = 'upsc-arguments-level-4.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'upsc-arguments-level-4';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'upscargumentsl4';               // ⭐ Line 3: Unique global variable name for this engine
...
// ============================================
    ...
    const _JSON_BASE_PATH = '/vooo-ai/subjects/upsc-arguments/json-code/';
