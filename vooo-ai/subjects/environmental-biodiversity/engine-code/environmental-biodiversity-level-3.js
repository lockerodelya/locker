...
const _ENGINE_JSON_FILE     = 'environmental-biodiversity-level-3.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-biodiversity-level-3';
const _ENGINE_INSTANCE_NAME = 'environmentalbiodiversityl3';
