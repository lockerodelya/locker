...
const _ENGINE_JSON_FILE     = 'environmental-biodiversity-level-2.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-biodiversity-level-2';
const _ENGINE_INSTANCE_NAME = 'environmentalbiodiversityl2';
