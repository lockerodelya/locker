...
const _ENGINE_JSON_FILE     = 'environmental-sustainability-level-2.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-sustainability-level-2';
const _ENGINE_INSTANCE_NAME = 'environmentalsustainabilityl2';
