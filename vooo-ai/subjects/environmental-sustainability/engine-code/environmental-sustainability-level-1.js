...
const _ENGINE_JSON_FILE     = 'environmental-sustainability-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-sustainability-level-1';
const _ENGINE_INSTANCE_NAME = 'environmentalsustainabilityl1';
