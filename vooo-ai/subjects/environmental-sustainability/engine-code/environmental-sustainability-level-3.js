...
const _ENGINE_JSON_FILE     = 'environmental-sustainability-level-3.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-sustainability-level-3';
const _ENGINE_INSTANCE_NAME = 'environmentalsustainabilityl3';
...
// ============================================
    ...
    const _JSON_BASE_PATH = '/vooo-ai/subjects/environmental-sustainability/json-code/';
...
isTemplateComputable(template){
    ...
    return true;
        ...
        evaluateExpression(expr,variables){
            ...
            if(/[\+\-\*\^%]/.test(ev)&&!/[?:'"]/.test(ev))
                ev=ev.replace(/(\d)(?!e\d)([A-Za-z_][A-Za-z0-9_]*)/g,'$1*$2');
