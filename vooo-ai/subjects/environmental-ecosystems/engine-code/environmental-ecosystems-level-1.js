...
const _ENGINE_JSON_FILE     = 'environmental-ecosystems-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-ecosystems-level-1';
const _ENGINE_INSTANCE_NAME = 'environmentalecosystemsl1';
