...
const _ENGINE_JSON_FILE     = 'environmental-ecosystems-level-3.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-ecosystems-level-3';
const _ENGINE_INSTANCE_NAME = 'environmentalecosystemsl3';
