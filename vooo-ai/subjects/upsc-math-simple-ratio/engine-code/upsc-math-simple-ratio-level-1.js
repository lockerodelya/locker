...
const _ENGINE_JSON_FILE     = 'upsc-math-simple-ratio-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'upsc-math-simple-ratio-level-1';
const _ENGINE_INSTANCE_NAME = 'upscmathsimpleratiol1';
