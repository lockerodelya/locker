...
const _ENGINE_JSON_FILE     = 'environmental-pollution-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-pollution-level-1';
const _ENGINE_INSTANCE_NAME = 'environmentalpollutionl1';
