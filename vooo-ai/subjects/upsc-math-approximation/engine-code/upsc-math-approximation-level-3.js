...
const _ENGINE_JSON_FILE     = 'upsc-math-approximation-level-3.json';
const _ENGINE_CATEGORY_KEY  = 'upsc-math-approximation-level-3';
const _ENGINE_INSTANCE_NAME = 'upscmathapproximationl3';
