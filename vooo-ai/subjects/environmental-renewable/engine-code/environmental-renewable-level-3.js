...
const _ENGINE_JSON_FILE     = 'environmental-renewable-level-3.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-renewable-level-3';
const _ENGINE_INSTANCE_NAME = 'environmentalrenewablel3';
