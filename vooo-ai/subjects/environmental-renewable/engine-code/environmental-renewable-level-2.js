...
const _ENGINE_JSON_FILE     = 'environmental-renewable-level-2.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-renewable-level-2';
const _ENGINE_INSTANCE_NAME = 'environmentalrenewablel2';
