...
const _ENGINE_JSON_FILE     = 'chemistry-atomic-structure-level-2.json';
const _ENGINE_CATEGORY_KEY  = 'chemistry-atomic-structure-level-2';
const _ENGINE_INSTANCE_NAME = 'chemistryatomicstructurel2';
