...
const _ENGINE_JSON_FILE     = 'chemistry-atomic-structure-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'chemistry-atomic-structure-level-1';
const _ENGINE_INSTANCE_NAME = 'chemistryatomicstructurel1';
