...
const _ENGINE_JSON_FILE     = 'physics-atomic-nuclear-level-3.json';
const _ENGINE_CATEGORY_KEY  = 'physics-atomic-nuclear-level-3';
const _ENGINE_INSTANCE_NAME = 'physicsatomicnuclearl3';
