...
const _ENGINE_JSON_FILE     = 'physics-atomic-nuclear-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'physics-atomic-nuclear-level-1';
const _ENGINE_INSTANCE_NAME = 'physicsatomicnuclearl1';
