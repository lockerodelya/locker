...
const _ENGINE_JSON_FILE     = 'physics-forces-motion-level-2.json';
const _ENGINE_CATEGORY_KEY  = 'physics-forces-motion-level-2';
const _ENGINE_INSTANCE_NAME = 'physicsforcesmotionl2';
