...
const _ENGINE_JSON_FILE     = 'chemistry-chemical-bonding-level-3.json';
const _ENGINE_CATEGORY_KEY  = 'chemistry-chemical-bonding-level-3';
const _ENGINE_INSTANCE_NAME = 'chemistrychemicalbondingl3';
