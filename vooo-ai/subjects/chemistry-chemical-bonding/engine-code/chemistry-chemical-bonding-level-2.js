...
const _ENGINE_JSON_FILE     = 'chemistry-chemical-bonding-level-2.json';
const _ENGINE_CATEGORY_KEY  = 'chemistry-chemical-bonding-level-2';
const _ENGINE_INSTANCE_NAME = 'chemistrychemicalbondingl2';
