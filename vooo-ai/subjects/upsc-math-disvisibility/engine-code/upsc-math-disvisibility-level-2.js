...
const _ENGINE_JSON_FILE     = 'upsc-math-divisibility-level-2.json';
const _ENGINE_CATEGORY_KEY  = 'upsc-math-divisibility-level-2';
const _ENGINE_INSTANCE_NAME = 'upscmathdivisibilityl2';
