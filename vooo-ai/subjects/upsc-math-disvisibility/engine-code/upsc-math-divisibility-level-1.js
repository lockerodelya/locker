...
const _ENGINE_JSON_FILE     = 'upsc-math-divisibility-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'upsc-math-divisibility-level-1';
const _ENGINE_INSTANCE_NAME = 'upscmathdivisibilityl1';
...
// ============================================
    ...
    const _JSON_BASE_PATH = '/vooo-ai/subjects/upsc-math-disvisibility/json-code/';
...
applyMathFunctions(ev){
    ...
    for(let pass=0;pass<20;pass++){
        let changed=false;
        // ✅ ONLY strip standalone parens around single numbers — no partial arithmetic
