...
const _ENGINE_JSON_FILE     = 'environmental-water-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'environmental-water-level-1';
const _ENGINE_INSTANCE_NAME = 'environmentalwaterl1';
