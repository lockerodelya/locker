...
const _ENGINE_JSON_FILE     = 'upsc-analytical-seating-level-3.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'upsc-analytical-seating-level-3';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'upscanalyticalseatingl3';               // ⭐ Line 3: Unique global variable name for this engine
...
// ============================================
    ...
    const _JSON_BASE_PATH = '/vooo-ai/subjects/upsc-analytical-seating/json-code/';
