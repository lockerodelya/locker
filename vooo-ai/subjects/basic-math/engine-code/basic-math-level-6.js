...
const _ENGINE_JSON_FILE     = 'basic-math-level-6.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'basic-math-level-6';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'basicmathl6';               // ⭐ Line 3: Unique global variable name for this engine
