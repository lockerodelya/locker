...
const _ENGINE_JSON_FILE     = 'upsc-ds-geometry-level-5.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'upsc-ds-geometry-level-5';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'upscdsgeometryl5';               // ⭐ Line 3: Unique global variable name for this engine
...
// ============================================
    ...
    const _JSON_BASE_PATH = '/vooo-ai/subjects/upsc-ds-geometry/json-code/';
