...
const _ENGINE_JSON_FILE     = 'basic-general-knowledge-level-13.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'basic-general-knowledge-level-13';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'basicgeneralknowledgel13';               // ⭐ Line 3: Unique global variable name for this engine
