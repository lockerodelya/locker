...
const _ENGINE_JSON_FILE     = 'physics-astrophysics-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'physics-astrophysics-level-1';
const _ENGINE_INSTANCE_NAME = 'physicsastrophysicsl1';
