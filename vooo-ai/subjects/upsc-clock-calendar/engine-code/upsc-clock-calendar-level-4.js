...
const _ENGINE_JSON_FILE     = 'upsc-clock-calendar-level-4.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'upsc-clock-calendar-level-4';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'upscclockcalendarl4';               // ⭐ Line 3: Unique global variable name for this engine
