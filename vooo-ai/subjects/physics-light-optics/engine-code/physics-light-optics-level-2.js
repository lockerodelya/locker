...
const _ENGINE_JSON_FILE     = 'physics-light-optics-level-2.json';
const _ENGINE_CATEGORY_KEY  = 'physics-light-optics-level-2';
const _ENGINE_INSTANCE_NAME = 'physicslightopticsl2';
