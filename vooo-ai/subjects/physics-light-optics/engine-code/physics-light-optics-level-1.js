...
const _ENGINE_JSON_FILE     = 'physics-light-optics-level-1.json';
const _ENGINE_CATEGORY_KEY  = 'physics-light-optics-level-1';
const _ENGINE_INSTANCE_NAME = 'physicslightopticsl1';
