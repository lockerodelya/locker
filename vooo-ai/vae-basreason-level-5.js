...
const _ENGINE_JSON_FILE     = 'basreason-level-5.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'basreason-level-5';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'vaebasreasonl5';          // ⭐ Line 3: Unique global variable name for this engine
