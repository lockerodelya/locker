...
generateOptions(correctAnswer,template,variables){
    ...
    if(template.answer_label&&Array.isArray(template.answer_label)){
        ...
        const pool=['Valid','Not Valid','Both I and II','Only Conclusion I','Only Conclusion II','Neither I nor II','Only Assumption I','Only Assumption II','I, II and III','I and II only','I and III only','II and III only'];
        let opts=[...unique];
