...
const _ENGINE_JSON_FILE     = 'gk-level-3.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'gk-level-3';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
const _ENGINE_INSTANCE_NAME = 'vaegkl3';               // ⭐ Line 3: Unique global variable name for this engine
