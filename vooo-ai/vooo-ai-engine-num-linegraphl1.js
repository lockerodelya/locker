...
const _ENGINE_JSON_FILE     = 'num-linegraph-level-1.json';       // ⭐ Line 1: Your JSON filename
const _ENGINE_CATEGORY_KEY  = 'num-linegraph-level-1';            // ⭐ Line 2: Category key (must match dropdown value in HTML)
